		...
		<div class="col-md-10">
			...
			<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<li>
					<form class="navbar-form navbar-right" role="search" method="post" action="verifica.php">
						<div class="form-group">
							<input type="text" name="ncontrol" class="form-control" placeholder="No. Control o Usuario" required />
							<input type="password" name="p1" class="form-control" pattern='.{6,}' required placeholder="Contraseña" />
						</div> 
			...
			<h2><strong>Seguimiento de Egresados</strong></h2>
			<center><img src="images/dgeti.png" width="200" alt="DGTI"/></center>
			<p>&nbsp;</p>
			<h3>Presentación</h3>
			...
			<div class="carousel slide" id="carousel-235307">
				<ol class="carousel-indicators">
					<li class="active" data-slide-to="0" data-target="#carousel-235307">
					</li>
					<li data-slide-to="1" data-target="#carousel-235307">
					</li>
					<li data-slide-to="2" data-target="#carousel-235307">
					</li>
				</ol>
				<div class="carousel-inner">
					<div class="item active">
						<img alt="CBTIS 61, Huamantla, Tlaxcala." src="images/cbtis61.png">
						<div class="carousel-caption">
							<h4>
								CBTIS 61, Huamantla, Tlax.
							</h4>
							<p>
							Bienvenidos
							</p>
					...
					<div class="item">
						<img alt="CBTIS 61, Huamantla, Tlaxcala." src="images/cbtis612.png">
						<div class="carousel-caption">
							<h4>
								Aniversario
							</h4>
							<p>
								42 años haciendo historis
							</p>
						</div>
					</div>
					<div class="item">
						<img alt="CBTIS 61, Huamantla, Tlaxcala." src="images/cbtis613.png">
						<div class="carousel-caption">
							<h4>
								Comunidad
							</h4>
				...
				</div> <a class="left carousel-control" href="#carousel-235307" data-slide="prev"><span class="glyphicon glyphicon-chevron-left"></span></a> <a class="right carousel-control" href="#carousel-235307" data-slide="next"><span class="glyphicon glyphicon-chevron-right"></span></a>
			</div>
			<h2>&nbsp;</h2>
